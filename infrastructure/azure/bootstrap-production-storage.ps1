param(
  ...
  [int]$MarketDataDailyRequestHardCap
)
...
Write-Host "Market-data request hard cap: $MarketDataDailyRequestHardCap units per UTC day per user (operator ceiling)"
Write-Host ""
