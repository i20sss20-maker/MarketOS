...
az staticwebapp appsettings set --name $AppName --resource-group $ResourceGroup --setting-names MARKET_DATA_PROVIDER=demo MARKET_EVENTS_PROVIDER=demo AI_PROVIDER=local-chart-engine MARKETOS_ENVIRONMENT=azure-preview --output none
